...
public abstract class MoviesDataBase extends RoomDatabase {
    ...
    private static MoviesDataBase instanse;
    ...
    public static synchronized MoviesDataBase getInstance(Context context) {
        if (instanse == null) {
            instanse = Room.databaseBuilder(context, MoviesDataBase.class, "movies_db")
    ...
    private static RoomDatabase.Callback callback = new RoomDatabase.Callback() {
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            super.onCreate(db);
            new InitialAsyncTask(instanse).execute();
        }
    };
    ...
    private static class InitialAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        public InitialAsyncTask(MoviesDataBase moviesDataBase) {
